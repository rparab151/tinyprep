...
export const mealLibrary: Meal[] = [
  meal({
    ...
    prepMinutes: 18,
    freezerNotes: "Refrigerate 2 days. Freeze with parchment between strips.",
  ...
  meal({
    ...
    prepMinutes: 28,
    freezerNotes: "Freeze cooked wedges up to 1 month.",
    ...
    tags: ["freezer", "vegetarian", "protein"],
    ingredients: [
  ...
  meal({
    ...
    prepMinutes: 18,
    freezerNotes: "Store filling 3 days. Assemble fresh for best texture.",
  ...
  meal({
    ...
    prepMinutes: 30,
    freezerNotes: "Freeze in small portions up to 2 months.",
  ...
  meal({
    ...
    batchYield: "4 snack cups",
    prepMinutes: 8,
    freezerNotes: "Fridge 1 day. Best fresh.",
  ...
  meal({
    ...
    prepMinutes: 18,
    freezerNotes: "Fridge 2 days. Rice texture is best fresh.",
  ...
  meal({
    ...
    prepMinutes: 22,
    freezerNotes: "Freeze cooked salmon separately up to 1 month.",
  ...
  meal({
    ...
    prepMinutes: 24,
    freezerNotes: "Fridge 2 days. Freeze broth and tofu without noodles.",
  ...
  meal({
    ...
    prepMinutes: 32,
    freezerNotes: "Freeze in small portions up to 1 month.",
  ...
  meal({
    ...
    batchYield: "4 small bowls",
    prepMinutes: 20,
    freezerNotes: "Fridge 2 days. Best not frozen.",
  ...
  meal({
    ...
    prepMinutes: 30,
    freezerNotes: "Freeze cooked filling up to 2 months.",
  ...
  meal({
    ...
    batchYield: "4 bowls",
    prepMinutes: 10,
    freezerNotes: "Fridge 2 days. Do not freeze assembled bowls.",
  ...
  meal({
    ...
    prepMinutes: 26,
    freezerNotes: "Freeze up to 1 month with extra moisture.",
  ...
  meal({
    ...
    prepMinutes: 30,
    freezerNotes: "Freeze cooked kofta up to 2 months.",
  ...
  meal({
    ...
    prepMinutes: 8,
    freezerNotes: "Fridge hummus 3 days. Do not freeze assembled plate.",
