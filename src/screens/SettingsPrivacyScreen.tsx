...
export function SettingsPrivacyScreen({ navigation, preferences }: Props) {
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <Text style={styles.subtitle}>TinyPrep is designed as an offline-first daily meal tool.</Text>

      <Card>
        <ListRow title="Storage" subtitle="Meal preferences are stored locally on this device." />
      ...
      <Card>
        ...
        <ListRow title="Saved grocery items" trailing={`${preferences.groceryCheckedIds.length}`} />
      </Card>
